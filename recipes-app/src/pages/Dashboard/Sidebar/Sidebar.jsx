                ...
                <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style={{ width: 280 + "px", height: 100 + "vh" }}>
                    ...
                    <ul className="nav nav-pills flex-column mb-auto">
                        <li className="nav-item">
                            <NavLink className="nav-link text-white" to="/dashboard/add">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link text-white" to="/dashboard/products">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="currentColor" class="bi bi-grid" viewBox="0 0 16 16">
                    ...
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1" >
                            ...
                            <li lass="dropdown-divider"><hr></hr></li>
