                ...
                <ul className="nav nav-pills flex-column mb-auto">
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link text-white" to="/dashboard/users">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="currentColor" className="bi bi-people-fill" viewBox="0 0 16 16">
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link text-white" to="/dashboard/products">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="currentColor" className="bi bi-grid" viewBox="0 0 16 16">
